// Slightly adapted from https://github.com/oliverbinns/d3gauge
     ...
     var  pathTickMaj = tickCalcMaj(),
      ...
      needlePath.transition()
          ...
          .attrTween("transform", function(d,i,a)
          {
              ...
              return d3.interpolateString("rotate(0," + needleCentre + ")", "rotate(" + (+needleAngle - opt.zeroNeedleAngle) + "," + needleCentre + ")")
      ...
      let updateGauge = function(newVal) {
